...
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate overall PLCC/SRCC for SA-IQA prompt3 results.")
    parser.add_argument(
        "--results_dir",
        type=str,
        default="../results",
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to save merged CSV. Defaults to ../results/all_prompt3_sa-iqa-prompt3.csv",
    )
    parser.add_argument(
        "--model_name",
        type=str,
        default="sa-iqa-prompt3",
...
#   python evaluate_correlation_prompt3.py
#
...
#   python evaluate_correlation_prompt3.py \
#       --results_dir ../results \
#       --output_csv ../results/all_prompt3_sa-iqa-prompt3.csv
#
# Run from the project root:
#   python SA-IQA/tools/evaluate_correlation_prompt3.py \
