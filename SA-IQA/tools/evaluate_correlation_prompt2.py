...
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate overall PLCC/SRCC for SA-IQA prompt2 results.")
    parser.add_argument(
        "--results_dir",
        type=str,
        default="../results",
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to save merged CSV. Defaults to ../results/all_prompt2_sa-iqa-prompt2.csv",
    )
    parser.add_argument(
        "--model_name",
        type=str,
        default="sa-iqa-prompt2",
...
#   python evaluate_correlation_prompt2.py
#
...
#   python evaluate_correlation_prompt2.py \
#       --results_dir ../results \
#       --output_csv ../results/all_prompt2_sa-iqa-prompt2.csv
#
# Run from the project root:
#   python SA-IQA/tools/evaluate_correlation_prompt2.py \
