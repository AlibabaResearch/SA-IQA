...
def get_default_test_jsonl(data_root: str, dimension: str) -> str:
    ...
    return os.path.join(
        data_root,
        "annotations",
        f"{dimension}_{subset}_test_prompt2.jsonl",
    )
...
def parse_args():
    parser = argparse.ArgumentParser(description="Inference and evaluation script for SA-IQA prompt2.")
    ...
    parser.add_argument(
        "--model_path",
        type=str,
        default="../../SA-IQA-model/sa-iqa-prompt2",
        help="Path to the trained SA-IQA prompt2 model.",
    )
    parser.add_argument(
        "--data_root",
        type=str,
...
def main():
    ...
    message_content = PROMPT2[args.dimension]
    ...
    result_stem = f"{args.dimension}_prompt2_{model_name}"
...
#   python infer_prompt2.py --mode all --dimension lighting
#
# Full pipeline for each dimension:
#   python infer_prompt2.py --mode all --dimension distortion
#   python infer_prompt2.py --mode all --dimension harmony
#   python infer_prompt2.py --mode all --dimension layout
#   python infer_prompt2.py --mode all --dimension lighting
#
# Inference only:
#   python infer_prompt2.py --mode infer --dimension lighting
#
# Score conversion only:
#   python infer_prompt2.py --mode score --dimension lighting
#
# Evaluation only:
#   python infer_prompt2.py --mode eval --dimension lighting
#
# Explicitly specify model/data/results paths:
#   python infer_prompt2.py \
#       --mode all \
#       --dimension lighting \
#       --model_path ../../SA-IQA-model/sa-iqa-prompt2 \
#       --data_root ../../SA-BENCH \
#       --results_dir ../results
#
# Run from the project root:
#   python SA-IQA/tools/infer_prompt2.py \
#       --mode all \
#       --dimension lighting \
#       --model_path ./SA-IQA-model/sa-iqa-prompt2 \
#       --data_root ./SA-BENCH \
...
#       --mode all \
#       --dimension lighting \
#       --test_jsonl ../../SA-BENCH/annotations/lighting_3k_test_prompt2.jsonl \
#       --input_csv ../../SA-BENCH/annotations/lighting_3k_test.csv \
#       --output_jsonl ../results/lighting_prompt2_sa-iqa-prompt2.jsonl \
#       --output_csv ../results/lighting_prompt2_sa-iqa-prompt2.csv
